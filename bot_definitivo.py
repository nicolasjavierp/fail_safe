...
```"
    ascendant_dict={
        0: ["ᴀʟᴛᴀʀ ᴀʙᴀɴᴅᴏɴᴀᴅᴏ - ᴊᴀʀᴅɪɴᴇs ᴅᴇ ᴇsɪʟᴀ","https://media.discordapp.net/attachments/508999396835196950/520280444277751828/Jardines_de_Esila.png"],
        1: ["ʀᴜɪɴᴀs ǫᴜᴇsʙʀᴀᴊᴀᴅᴀs – ᴇsᴘɪɴᴀ ᴅᴇ ᴋᴇʀᴇs","https://media.discordapp.com/attachments/508999396835196950/520280396366086154/Espina_de_Keres.png"],
        2: ["ғᴏʀᴛᴀʟᴇᴢᴀ ᴅᴇ ғɪʟᴏs ᴄᴏʀᴛᴀɴᴛᴇs - ʀᴇᴛɪʀᴏ ᴅᴇʟ ʜᴇʀᴀʟᴅᴏ","https://media.discordapp.com/attachments/508999396835196950/520280494722514964/Reclusion_del_Heraldo.png"],
        3: ["ᴀʙɪsᴍᴏ ᴀɢᴏɴᴀʀᴄʜ – ʙᴀʜɪᴀ ᴅᴇ ʟᴏs ᴅᴇsᴇᴏs ᴀʜᴏɢᴀᴅᴏs","https://media.discordapp.com/attachments/508999396835196950/520280295413514253/Bahia_de_los_Deseos_Ahogados.png"],
        4: ["ɢᴜᴀʀɴɪᴄɪᴏɴ ᴄɪᴍᴇʀᴀ - ᴄᴀᴍᴀʀᴀ ᴅᴇ ʟᴜᴢ ᴅᴇ ᴇsᴛʀᴇʟʟᴀs","https://media.discordapp.com/attachments/508999396835196950/520280358630064149/Camara_de_Luz_Estelar.png"],
        5: ["ᴏᴜʀᴏʙᴏʀᴇᴀ – ʀᴇᴘᴏsᴏ ᴅᴇʟ ᴀғᴇʟɪᴏ","https://media.discordapp.com/attachments/508999396835196950/520280560724344862/Reposo_de_Afelio.png"],
        6: ["ᴀʟᴛᴀʀ ᴀʙᴀɴᴅᴏɴᴀᴅᴏ - ᴊᴀʀᴅɪɴᴇs ᴅᴇ ᴇsɪʟᴀ","https://media.discordapp.com/attachments/508999396835196950/520280444277751828/Jardines_de_Esila.png"]
    }
    today = datetime.now()
    key = datetime.date(today).isocalendar()[1]

    protocol_dict={
        0: ["IKELOS_SMG_v1.0.1 (Subfusil)","https://media.discordapp.com/attachments/508999396835196950/520269508728979467/Subfusil.png"],
        1: ["IKELOS_SR_v1.0.1 (Francotirador)","https://media.discordapp.com/attachments/508999396835196950/520269665478508544/Francotirador.png"],
        2: ["IKELOS_SG_v1.0.1 (Escopeta), IKELOS_SMG_v1.0.1 (Subfusil), IKELOS_SR_v1.0.1 (Francotirador)","https://media.discordapp.com/attachments/508999396835196950/520270412421267456/unknown.png"],
        3: ["IKELOS_SG_v1.0.1 (Escopeta), IKELOS_SMG_v1.0.1 (Subfusil), IKELOS_SR_v1.0.1 (Francotirador)","https://media.discordapp.com/attachments/508999396835196950/520270412421267456/unknown.png"],
        #4: ["IKELOS_SG_v1.0.1 (Escopeta)","https://media.discordapp.com/attachments/508999396835196950/520269571253600271/Escopeta.png"]
        4: ["IKELOS_SG_v1.0.1 (Escopeta)","https://media.discordapp.com/attachments/508999396835196950/520270412421267456/unknown.png"]
    }
