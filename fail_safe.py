...
class FailSafe(object):
    ...
    def __init__(self, api_key):
        ...
        self.xur_locations={"IO":"en IO en la zona de Cicatriz del Gigante","TITAN":"en Titan en la zona Plataforma","EDZ":"la Tierra (ZME), en la zona Bahía del Viento ","NESSUS":"en Nessus en la zona de Tumba del Vigia","TOWER":"la torre en la zona de Hangar detras de Orbita Muerta"}
